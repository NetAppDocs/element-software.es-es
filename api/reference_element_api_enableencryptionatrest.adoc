...
[NOTE]
====
* Este método no habilita el cifrado de software en reposo. Esto sólo se puede hacer usando link:../api/reference_element_api_createcluster.html["cree el método de clúster"^] con `enableSoftwareEncryptionAtRest` establezca en `true`.
