...
[role="lead"]
Puede utilizar el `SetSSLCertificate` Método para establecer un certificado SSL de usuario y una clave privada para los nodos de almacenamiento del clúster.
