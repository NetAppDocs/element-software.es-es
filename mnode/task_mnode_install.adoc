...
NOTE: No edite el NTP después de completar la configuración de sincronización horaria, ya que esto afecta al NTP cuando se ejecuta. <<set-up-the-management-node,comando setup>> en el nodo de gestión.
