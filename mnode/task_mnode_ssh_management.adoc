...
NOTE: Para habilitar o deshabilitar el acceso de soporte con SSH para un clúster de almacenamiento, debe usar el link:../storage/task_system_manage_cluster_enable_and_disable_support_access.html["Página de configuración del clúster de la interfaz de usuario de Element"].
