...
+
Verlink:../api/concept_element_api_about_the_api.html["Referencia de API del software NetApp Element"] .
...
link:concept_system_manage_manage_ldap.html["Habilite la autenticación de LDAP con la interfaz de usuario de Element"]
