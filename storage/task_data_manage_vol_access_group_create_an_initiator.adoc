...
Para obtener más detalles, consulte la información de referencia de la API. link:../api/concept_element_api_about_the_api.html["Gestione el almacenamiento con la API de Element"]
