...
Para obtener más detalles sobre los métodos de la API, consulte link:../api/concept_element_api_about_the_api.html["Gestione el almacenamiento con la API de Element"].
